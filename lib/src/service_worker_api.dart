...
class ServiceWorkerGlobalScope {
  ...
  static final ServiceWorkerGlobalScope globalScope =
      new ServiceWorkerGlobalScope._(facade.globalScopeSelf as Object);
  ...
  Stream<ExtendableEvent> get onActivate => _onActivate ??= callbackToStream(
      _delegate, 'onactivate', (dynamic j) => new ExtendableEvent._(j));

  /// An event handler fired whenever a fetch event occurs — when a fetch()
  /// is called.
  Stream<FetchEvent> get onFetch => _onFetch ??=
      callbackToStream(_delegate, 'onfetch', (dynamic j) => new FetchEvent._(j));
  ...
  Stream<InstallEvent> get onInstall => _onInstall ??=
      callbackToStream(_delegate, 'oninstall', (dynamic j) => new InstallEvent._(j));
  ...
  Stream<ExtendableMessageEvent> get onMessage =>
      _onMessage ??= callbackToStream(
          _delegate, 'onmessage', (dynamic j) => new ExtendableMessageEvent._(j));
  ...
  Stream<NotificationEvent> get onNotificationClick =>
      _onNotificationClick ??= callbackToStream(
          _delegate, 'onnotificationclick', (dynamic j) => new NotificationEvent._(j));
  ...
  Stream<PushEvent> get onPush => _onPush ??=
      callbackToStream(_delegate, 'onpush', (dynamic j) => new PushEvent._(j));
  ...
  Stream<PushEvent> get onPushSubscriptionChange =>
      _onPushSubscriptionChange ??= callbackToStream(
          _delegate, 'onpushsubscriptionchange', (dynamic j) => new PushEvent._(j));
  ...
  Future<Response> fetch(dynamic /*Request|String*/ request,
    ...
    return promiseToFuture(
        _callMethod(_delegate, 'fetch', args), (dynamic j) => new Response._(j));
  }
...
class ServiceWorkerContainer {
  ...
  static final ServiceWorkerContainer? navigatorContainer =
      facade.navigatorContainer == null
          ? null
          : new ServiceWorkerContainer._(facade.navigatorContainer);
  ...
  Future<ServiceWorkerRegistration> get ready => promiseToFuture(
      ...
      (dynamic j) => new ServiceWorkerRegistration._(j));
  ...
  Stream<Event> get onControllerChange => _onControllerChange ??=
      callbackToStream(_delegate, 'oncontrollerchange', (dynamic j) => j as Event);

  /// An event handler fired whenever an error event occurs in the associated
  /// service workers.
  Stream<ErrorEvent> get onError => _onError ??=
      callbackToStream(_delegate, 'onerror', (dynamic j) => j as ErrorEvent);
  ...
  Stream<MessageEvent> get onMessage => _onMessage ??=
      callbackToStream(_delegate, 'onmessage', (dynamic j) => j as MessageEvent);
...
class CacheStorage {
  ...
  Future<Cache> open(String cacheName) => promiseToFuture(
      _callMethod(_delegate, 'open', [cacheName]), (dynamic j) => new Cache._(j));
...
class ServiceWorkerClients {
  ...
  Future<ServiceWorkerClient> operator [](String clientId) => promiseToFuture(
      ...
      (dynamic j) => new ServiceWorkerClient._(j));
  ...
  Future<WindowClient> openWindow(String url) => promiseToFuture(
      ...
      (dynamic j) => new WindowClient._(j));
...
class ServiceWorkerRegistration implements EventTarget {
  ...
  Stream get onUpdateFound => _onUpdateFound ??=
      callbackToStream(_delegate, 'onupdatefound', (dynamic j) => null);
  ...
  Future<NotificationEvent> showNotification(String title,
    ...
    return promiseToFuture(_callMethod(_delegate, 'showNotification', args),
        (dynamic j) => new NotificationEvent._(j));
  }
}
...
class PushManager {
  ...
  Future<PushSubscription> subscribe([PushSubscriptionOptions? options]) =>
      promiseToFuture(_callMethod(_delegate, 'subscribe', [options]),
          (dynamic j) => new PushSubscription._(j));
...
class PushSubscription {
  ...
  Map<String, String> getKeysAsString() {
    var map =
        json.decode(facade.jsonStringify(_delegate as Object)) as Map<String, dynamic>;
    var keys = map['keys'];
    if (keys is Map) {
...
class ServiceWorker implements Worker {
  ...
  Stream<Event> get onStateChange => _onStateChange ??=
      callbackToStream(_delegate, 'onstatechange', (dynamic j) => j as Event);
...
T _callMethod<T>(object, String method, List args) =>
    js_util.callMethod(object as Object, method, args) as T;

// Utility method to mask the typed JS facade as JSObject
T _getProperty<T>(object, String name) =>
    js_util.getProperty(object as Object, name) as T;
